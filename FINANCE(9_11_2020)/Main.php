...
/**
    * Name : adminMenu
    * Purpose : To display the admin menu  
    * Input : void
    * Returns : void
*/
...
/**
    * Name : customerMenu
    * Purpose : To display the customer menu  
    * Input : void
    * Returns : void
*/
...
/**
    * Name : mainMenu
    * Purpose : To display the main menu  
    * Input : void
    * Returns : void
*/
...
/**
    * Name : rootMenu
    * Purpose : To display the root user menu  
    * Input : void
    * Returns : void
*/
...
/**
    ...
    * Purpose : To perform the admin operations like
    *           adding loans, adding customers.. etc; 
    * Input : void
    * Returns : void
*/
...
/**
    ...
    * Purpose : To perform the customer operations like
    *           applying loans, paying installments.. etc; 
...
/**
    * Name : rootOperations
    * Purpose : To perform root operations like
    *           adding admins,Updating Address.. etc; 
    * Input : void
    * Returns : void
*/
...
# looping through until option entered is 'exit'
do
{
